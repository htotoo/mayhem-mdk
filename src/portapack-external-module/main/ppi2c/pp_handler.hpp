...
public:
    ...
    static void add_cutsom_command(uint16_t command, pp_i2c_command got_command, pp_i2c_command send_command); // this will add a custom command to the module, see pp_custom_command_list_element_t!
